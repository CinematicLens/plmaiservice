...
window.PLMOPS_CONFIG = {
  ...
  SITE_TAGLINE: "Affordable BOM and ERP data tools for Indian manufacturers",
  ...
  WHATSAPP_URL: "",
  /* Set true only if you can issue GST invoices for B2B sales. */
  ...
  products: {
    ...
    bom: {
      ...
      priority: 1,
      statusLabel: "B2B · Available for demo",
      statusClass: "b2b",
    ...
    bapi: {
      ...
      priority: 4,
      statusLabel: "Pilot enquiries open",
      statusClass: "pilot",
      problem: "Validate Excel/CSV manufacturing data offline, then load through customer-authorized SAP remote functions.",
      description: "B2B Windows workstation for SAP master-data analysts and consultants: validate Excel/CSV offline, map with declarative profiles, plan create/change/skip, then submit customer-allowlisted remote functions. Independent product — not affiliated with SAP SE. SAP .NET Connector is not included. Pilot / evaluation enquiries welcome.",
      storeUrl: "",
      storeReady: false,
      storeComingSoon: "Pilot enquiries — write to sanjay@plmaiservice.com",
      salesModel: "b2b",
      trial: "Pilot and B2B evaluation. Contact sanjay@plmaiservice.com for commercial terms.",
