...
window.PLMOPS_CONFIG = {
  ...
  products: {
    ...
    releaseguard: {
      ...
      priority: 5,
      statusLabel: "Microsoft Store · Coming soon",
      statusClass: "pilot",
      problem: "Catch revision, quantity, price, material and delivery differences between RFQ, quote and PO before release.",
      description: "Windows review workstation that compares RFQ, accepted quotation, customer PO and later revisions with source-linked discrepancies. A person still approves. Offline-first. Does not talk to ERP or auto-enter orders. Microsoft Store listing coming soon.",
      storeUrl: "",
      storeReady: false,
      storeComingSoon: "Microsoft Store listing coming soon",
      salesModel: "store_pending",
      trial: "Microsoft Store listing coming soon.",
