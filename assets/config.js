...
window.PLMOPS_CONFIG = {
  ...
  SITE_TAGLINE: "Manufacturing data ecosystem — BAPI Guard and focused Windows tools worldwide",
  SUPPORT_EMAIL: "teamcentersap@gmail.com",
  B2B_EMAIL: "sanjay@plmaiservice.com",

  /* Set to a full wa.me URL (e.g. https://wa.me/91XXXXXXXXXX) to enable WhatsApp CTAs. Leave empty to hide. */
  WHATSAPP_URL: "",
  /* Set true only if you can issue GST invoices for India B2B sales. */
  GST_INVOICE_AVAILABLE: false,
  CURRENCY_PRIMARY: "",
  CURRENCY_NOTE: "",
  ...
  products: {
    ...
    bom: {
      ...
      storeLabel: "Get from Microsoft Store",
      salesModel: "store",
    ...
    bapi: {
      ...
      description: "Featured Windows workstation for SAP master-data analysts and consultants: validate Excel/CSV offline, map with declarative profiles, plan create/change/skip, then submit customer-allowlisted remote functions. Available on Microsoft Store. Independent product — not affiliated with SAP SE. SAP .NET Connector is not included.",
      storeUrl: "https://apps.microsoft.com/detail/9mx813429bp3?hl=en-US&gl=IN",
      storeReady: true,
      storePlatform: "microsoft",
      storeLabel: "Get from Microsoft Store",
      salesModel: "store",
      trial: "See Microsoft Store for trial and licensing details.",
      screenshot: "assets/img/bapiload-guard-sales.png",
      ogImage: "assets/img/bapiload-guard-sales.png",
      demoUrl: "",
      demoTitle: "BAPILoad Guard Demo",
      storeEvent: "click_bapi_store",
    ...
    releaseguard: {
      ...
      description: "Windows review workstation that compares RFQ, accepted quotation, customer PO and later revisions with source-linked discrepancies. Listed on Microsoft Store as Manufacturing RFQ & PO Validator. A person still approves. Offline-first. Does not talk to ERP or auto-enter orders.",
      storeUrl: "https://apps.microsoft.com/detail/9pb8h811bg57?hl=en-US&gl=IN",
      storeReady: true,
      storePlatform: "microsoft",
      storeLabel: "Get from Microsoft Store",
      salesModel: "store",
      trial: "See Microsoft Store for trial and licensing details.",
      screenshot: "assets/img/order-release-guard-ui.png",
      ogImage: "assets/img/order-release-guard-ui.png",
      demoUrl: "",
      demoTitle: "OrderRelease Guard Demo",
      storeEvent: "click_releaseguard_store",
